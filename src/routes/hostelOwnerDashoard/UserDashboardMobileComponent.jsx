...
import { CreatedListings } from './UserDashboardDektopComponent';
  ...
  const handleGoBack = () => {
    ...
    return(
        <div className='bg-[#07a0c3] h-[8vh] w-full gap-5 pt-1 flex flex-row justify-evenly items-center text-white font-normal fixed bottom-0 font-[calc(10px + 2vmin)]'>
            ...
            <Link to={''}>
            <div className='flex flex-col items-center  font-sans  text-sm mt-[1px]'>
                <button type="button" className='h-6 w-6 bg-cover bg-no-repeat'>
...
export default function UserDashboardMobileHomePage() {
  return(
    <>
