...
function BottomBar() {
  ...
  const handleGoBack = () => {
    ...
    return(
        <div className='bg-[#58e9af] h-[9vh] pt-1 w-[40vw] gap-5 flex flex-row justify-evenly items-center  font-normal text-white fixed bottom-6 shadow-lg rounded-lg font-[calc(10px + 2vmin)]'>
