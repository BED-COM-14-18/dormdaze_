...
export function MenuBt() {
  ...
  return (
      <div className='flex justify-center'>
          ...
          <Button icon="pi pi-arrow-right" onClick={() => setVisible(true)} className=''>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-list" viewBox="0 0 16 16" className='size-7 fill-white'>
