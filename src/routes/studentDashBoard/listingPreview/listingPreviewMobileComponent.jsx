...
// import { Description } from "./listingPreviewDesktopComponent";
// import { Link } from "react-router-dom";
// import { useLocation } from 'react-router-dom';
// import  RateReadOnly  from "./readonlyrating";
...
// function TopBar() {
//     return(
//         <div className='bg-{hsl(0, 12%, 89%)} h-12 w-full flex justify-start fixed top-0 items-center p-0'>
//             <Link to={'/'}>
//               <div className='bg-[#e33d2800] ml-4 mt-2'>
...
//         <Slide>
//          {urls.map((url)=> (
//             <div key={urls.length} className='flex flex-row items-center justify-center'>
...
//     return(
//         <div className='bg-[#c8cedb] h-[7vh] w-full flex flex-row items-center justify-evenly fixed bottom-0 gap-14'>
//             <p className='mt-1 ml-2 text-xl font-normal text-black flex flex-row items-center gap-3 border-black'>
//                     <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cash-coin" viewBox="0 0 16 16" className='size-6 content-center'>
...
//             <div className='flex flex-col gap-x-1 pb-2'>
...
//                         <div className='grid grid-cols-2 gap-1 place-items-start justify-between w-full'>
//                             <Amenities />
